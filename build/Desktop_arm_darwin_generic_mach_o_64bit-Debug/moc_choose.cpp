...
Q_CONSTINIT static const uint qt_meta_data_ZN6CHOOSEE[] = {
...
Q_CONSTINIT const QMetaObject CHOOSE::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN6CHOOSEE.offsetsAndSizes,
    qt_meta_data_ZN6CHOOSEE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN6CHOOSEE_t,
        // Q_OBJECT / Q_GADGET
...
void CHOOSE::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->onProcessButtonClicked(); break;
...
void *CHOOSE::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN6CHOOSEE.stringdata0))
